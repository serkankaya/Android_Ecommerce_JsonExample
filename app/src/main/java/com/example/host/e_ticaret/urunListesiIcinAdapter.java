 ...
 */
public class urunListesiIcinAdapter extends BaseAdapter{
    private LayoutInflater inf;
    private List<urun> urls;
    private Activity ac;
    public urunListesiIcinAdapter(Activity ac, List<urun> urls){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View view1;
        tikla = i;
        view1=inf.inflate(R.layout.urunlistesirow,null);
        TextView urunBasliktxt=(TextView)view1.findViewById(R.id.urunbasliktxt);
        TextView urunFiyattxt=(TextView)view1.findViewById(R.id.urunfiyattxt);
        ImageView vresim=(ImageView)view1.findViewById(R.id.urunresimImageView);
